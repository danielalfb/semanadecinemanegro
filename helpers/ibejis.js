export const IEBEJIS = [
    {
        ...
        fotografia: Samuel Fonseca, Victor Alexandre;
        montagem: Misael Avelino, Samuel Fonseca, Monike Fernandes, Victor Alexandre;
        arte e figurino: Victor Piroli, Monike Fernandes, Marta Fernandes;
        som: Yara Tôrres;
      ...
      },
      {
        ...
        fotografia: Felipe Alex;
        montagem: Marcelo Egnster;
        arte e figurino: Carsons Clay;
        som: Jonas Costa;
        elenco principal: Pedro Samuel Nascimento, Sara Barbosa;
      ...
      },
      {
        ...
        fotografia: Letícia França, Luiza Bomfim;
        montagem: Lu Silva;
        arte e figurino: Natanna Pereira, Laryssa Almeida;
        som: Marise Urbano, Adam Viana;
        elenco principal: Elisa Lemos, Quésia Sonza, Michelle Pereira, Lulu  Sousa, Thaty Meneses, Rita Maia;
      ...
      },
      {
        ...
        montagem: Jonas Rosa;
        arte e figurino: Giulia Maria Reis, Renata Alves;
        som:  Márcio Padilha, Marcus Padilha;
        elenco principal: Lidiane Oliveira, Dominick Di Calafrio, João Pedro Zabeti, Laís Lage, Pablo Vinicio, Paulo Victor Lino, Peterson Oliveira, Preta Queen B. Rull, Rafael Bento, Cyda Moreno;
      ...
      },
      {
        ...
        arte e figurino: Raquel Rocha;
        som: Bob Bastos, Luciano Tucunduva;
        trilha sonora original: Bob Bastos;
        elenco principal: Ana Cordeiro;
