        ...
        >
          <div className="overflow-x-hidden relative appearance-none h-3/4 pt-40 pb-40 scroll-smooth w-full txtBlock z-10 past-pages">
            ...
            <div className="flex flex-col w-full mb-6 p-4 rounded-sm">
              ...
              <p>
                A 3ª edição da Semana de Cinema Negro de Belo Horizonte
                aconteceu presencialmente pela primeira vez e, por esse motivo,
                a presença do público foi essencial para a construção do
                festival. Promovemos um encontro marcado pelo afeto e
                acolhimento. Apresentamos, 09 a 17 de setembro de 2023, um
                conjunto composto por 70 filmes de cinematografias africanas,
                negras brasileiras e da diáspora, distribuído em três mostras,
                duas homenagens e uma Sessão Especial:{" "}
                <i>
            ...
            >
              ...
              <p>
                A 2ª edição da Semana de Cinema Negro de Belo Horizonte
                aconteceu presencialmente pela primeira vez e, por esse motivo,
                a presença do público foi essencial para a construção do
                festival. Promovemos um encontro marcado pelo afeto e
                acolhimento. Apresentamos, de 8 a 15 de setembro de 2022, um
                conjunto composto por 53 filmes de cinematografias africanas,
                negras brasileiras e da diáspora, distribuído em três mostras,
                duas homenagens e uma Sessão Especial:{" "}
                <i>
                  Por Outros Cinemas Africanos; Med Hondo: cinema e liberadade;
                  Cine-Escrituras Pretas; Sessão Homenagem Maria José Novais
                  Oliveira: Rejane Faria – no palco e nas telas; Semana de
                  Cinema Negro convida o NICHO 54; e Ibejis (Infatil)
                </i>
                ...
                do cineasta Med Hondo; e outra realizada por Alessandra Brito
                com Rejane Faria, a nossa homenageada da edição. O catálogo está
            ...
            >
              ...
              <p className="font-sans">
                A 1º edição da Semana de Cinema Negro de Belo Horizonte trouxe
                um olhar de resgate sobre as nossas memórias. Diante do momento
                de crise mundial, fez-se necessário visitar lembranças para
                despertar o desejo de vivê-las novamente. Apresentamos, de 10 a
                16 de abril de 2021, um conjunto composto por cinquenta filmes
                de cinematografias africanas, negras brasileiras, africanas e da
                diáspora, distribuído em três mostras e duas homenagens: Cinemas
                Africanos em revista: as origens do FESPACO; Surreal16
                Collective, Um Novo Olhar para o Cinema Nigeriano;
                <i>
                  Cine-Escrituras Pretas; Sessão Maria José Novais Oliveira:
                  Nossa atriz; e Cinema, negritude e poesia: uma homenagem a
                  Sarah Maldoror
                </i>
                . As conversas com convidadas e convidados estão disponíveis no
                canal do Youtube da Semana de Cinema Negro (acesse no{" "}
